...
## Alpha 3.6 — Holdings Only
- [x] Watch Score 改名為市場分析
- [x] 市場分析只顯示目前實際持股
- [x] 事件中心只顯示目前實際持股
- [x] 正2策略關閉時不出現 00685L
- [x] 完全停止黃金事件追蹤
...
- [x] 策略中心移除黃金持續買進
- [x] 策略中心移除緊急預備金管理
- [x] 舊模擬事件即使仍在資料庫，也不再顯示


## V5 AI Assistant Core
- [x] 首頁 Jay AI Assistant
- [x] 一句話今日決策
- [x] 「為什麼？」可展開判斷理由
- [x] 正2開啟時顯示調節比例與金額
- [x] 正2關閉時完全隱藏調節資訊
- [x] 內建問答：現金、加碼、事件、風險、正2平衡
- [x] 問答只讀取自己的資產、持股、策略與事件
- [ ] 串接正式 AI API
- [ ] 自動晨報
- [ ] 背景推播
- [ ] 官方事件資料連接器
...
## V5 AI Assistant Core v1.1
- [x] 完整刪除 009816 定期定額欄位
- [x] 完整刪除定期定額備註與計畫卡
- [x] 正2比例設定預設隱藏
- [x] 開啟正2平衡策略後才顯示比例與容忍區間
- [x] 關閉正2平衡策略後首頁不顯示調節資訊


## V5 AI Assistant Core v1.2
- [x] 刪除市場分析
- [x] 刪除 AI 市場模擬器
- [x] 刪除模擬事件按鈕
- [x] 刪除手動測試事件
